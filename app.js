...
//
// mongoose.connect("mongodb+srv://admin-Siri:vankayalapati@cluster0-m2cra.mongodb.net/userDB", {useNewUrlParser: true});
...
//       let user=users.getUser(socket.id);
//       if(user){
//         io.in(user.room).emit('newMessage',generateMessage("User",message.text));
//       }
//     });
//
//
...
passport.use(new GoogleStrategy({
     ...
     callbackURL: "http://localhost:3000/auth/google/LiveCode",
